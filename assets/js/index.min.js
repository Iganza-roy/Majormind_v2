...
(() => {
  'use strict';
  var e;
  (e = $('.menu-bar .main-menu ul').html()),
    $('.menu-bar .menu-bar-content').append(
      '<div class="mobile-menu-overlay">'
    ),
    $('h2').append('<div class="swiper-pagination-bullet-active">'),
    ...
    $('.menu-bar .mobile-menu-bar .mobile-menu-header').after(
    ...
    $(window).scroll(() => {
      ...
      n.hasClass('v1')
        ...
        : (n.hasClass('v2') || n.hasClass('v3')) &&
          ((e = $(window).scrollTop()),
          (576 <= screen.width && 20 < e) || (screen.width <= 576 && 0 < e)
            ? n.addClass('sticky-header')
            : n.removeClass('sticky-header'));
    }),
    ...
    function n(n) {
      if (!n.dataset.animated) {
        ...
        anime({
          targets: n,
          innerHTML: [
            parseInt(n.dataset.countMin) || 0,
            parseInt(n.dataset.countMax),
          ],
          round: 1,
          easing: 'linear',
          ...
          if (a && '' !== a.trim())
            if (s && '' !== s.trim())
              if (/^(\d{10}|\d{3}[-\s]\d{3}[-\s]\d{4})$/.test(i)) {
                ...
                r(
                  n,
                  'Please enter a valid number number (e.g., 123-456-7890 or 1234567890).',
                  'error'
                );
  ...
  function r(e, n, t = 'success') {
    anime
      ...
      e.removeClass('error' === t ? 'success' : 'error'),
      e.addClass(t),
      e.text(n);
  }
